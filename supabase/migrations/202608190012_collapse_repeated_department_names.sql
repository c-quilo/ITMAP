...
begin
  ...
  case identity_key
    ...
    when 'department of economics and public policy' then return 'Department of Economics and Public Policy';
...
comment on function public.itmap_canonical_organization_name(text) is
  'Normalises Imperial unit aliases, collapses repeated department labels, and rejects prose or compound affiliations.';
