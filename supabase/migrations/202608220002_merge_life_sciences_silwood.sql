...
begin
  ...
  case identity_key
    ...
    when 'department of life sciences silwood park' then return 'Department of Life Sciences';
...
comment on function public.itmap_canonical_organization_name(text) is
  'Normalises Imperial unit aliases, merges the Silwood Park Life Sciences label, groups Business School sub-departments, and rejects malformed affiliation prose.';
